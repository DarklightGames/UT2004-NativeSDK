...
class CORE_API UProperty : public UField
{
	...
	virtual void CopySingleValue( void* Dest, void* Src, UObject* SuperObject=NULL, INT arg3=0 ) const;
	virtual void CopyCompleteValue( void* Dest, void* Src, UObject* SuperObject=NULL, INT arg3=0 ) const;
	virtual UBOOL ClearValue(BYTE* arg0) const=0;
	virtual void DestroyValue(void* Dest) const;
	virtual UBOOL HasValue(const BYTE* arg0) const=0;
	virtual UBOOL Port() const;
	virtual BYTE GetID() const;
	virtual UBOOL IsLocalzied() const;
...
class CORE_API UByteProperty : public UProperty
{
	...
	void CopySingleValueCopySingleValue( void* Dest, void* Src, UObject* SuperObject=NULL, INT arg3=0 ) const;
	void CopyCompleteValue( void* Dest, void* Src, UObject* SuperObject=NULL, INT arg3=0 ) const;
	UBOOL ClearValue(BYTE* arg0) const;
	UBOOL HasValue(const BYTE* arg0) const;
};
